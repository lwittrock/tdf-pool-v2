  ...
  return (
    <div ref={wrapperRef} className="relative">
      <input
        ...
        disabled={disabled}
        className="w-full px-4 py-2.5 border border-gray-200 rounded-xl shadow-sm focus:outline-none focus:border-tdf-accent disabled:bg-gray-100 disabled:cursor-not-allowed"
      />
  ...
  return (
    <div ref={wrapperRef} className="relative">
      ...
      <input
        ...
        onFocus={() => setIsOpen(true)}
        placeholder={placeholder}
        className="w-full px-4 py-2.5 border border-gray-200 rounded-xl shadow-sm focus:outline-none focus:border-tdf-accent"
      />
